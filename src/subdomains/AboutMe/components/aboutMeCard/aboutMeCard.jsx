...
export const AboutMeCard = () => {
    return (
        <Container width="65%" display="flex" wrap="wrap" justify="center" align="center">
            ...
            <Container display="flex" align="center" justify="flex-end" height="50%">
                <img src={foto} style={{position: "absolute", left: 0, height: "50%"}}></img>
                <Container bg="var(--primary)" width="75%" margin="0" borderRadius="2rem">
                    <Container width="95%" margin="0 0 0 auto" padding="2rem">
